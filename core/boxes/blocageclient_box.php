 ...
 */
class blocageclientbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "blocageclient@blocageclient";
    public $boxlabel;
    public $depends = array("blocageclient");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/blocageclient/class/blocageclient.class.php";
